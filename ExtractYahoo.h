...
int ExtractIWB2( string StartDate, string EndDate, vector<double>& IWB, vector<string>& DATE )
{
...
int ExtractStock2(map<string, Stock>& StockList)
{
